<%@ Page Title="" Language="C#" MasterPageFile="~/users/MasterUsers.master" AutoEventWireup="true" CodeFile="MyDocuments.aspx.cs" Inherits="users_MyDocuments" %>
...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                             <li>
                                <i class="fa fa-dashboard"></i>  <a href="MyDashboard.aspx">Dashboard</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> My Documents
                            </li>
                        </ol>
                        <a href="Edit.aspx?t=doc" class="btn btn-info"><span class=" glyphicon glyphicon-plus-sign"></span> Add new document </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <asp:DataList ID="DataList1" runat="server" 
                        ...
                        <ItemTemplate>
                            <h2>
                                <a href="../document.aspx?b=<%# Eval("Text") %>">
                                    <%# Eval("Title") %></a>
                            </h2>
                            <p class="lead">
                                by <a href="#">
                            ...
                            <p>
                                <%# Eval("Description") %></p>
                            <asp:DataList ID="DocTags" runat="server" RepeatDirection="Horizontal" >
                            <ItemTemplate>
                           <a href="#" style="padding:5px; border-style:inset"><span class="glyphicon glyphicon-tag"></span><%# Eval("TagName") %></a> &nbsp; 
                            </ItemTemplate>
                            </asp:DataList>
                            </br>
                            <a class="btn btn-primary" href="../document.aspx?b=<%# Eval("Text") %>">View Document<span class="glyphicon glyphicon-chevron-right">
                            </span></a>&nbsp;&nbsp;&nbsp;&nbsp<a href="Edit.aspx?t=doc&b=<%# Eval("Text") %>" class="btn btn-primary"><i class="glyphicon glyphicon-edit">
                            </i>Edit </a>&nbsp;&nbsp;&nbsp;&nbsp
                            <hr />
                        </ItemTemplate>
                    </asp:DataList>
