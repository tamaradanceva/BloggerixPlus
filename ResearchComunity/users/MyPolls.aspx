<%@ Page Title="" Language="C#" MasterPageFile="~/users/MasterUsers.master" AutoEventWireup="true"
    CodeFile="MyPolls.aspx.cs" Inherits="users_MyPolls" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-user"></i>My Polls </li>
                </ol>
                <a href="Edit.aspx?t=poll" class="btn btn-info"><span class=" glyphicon glyphicon-plus-sign"></span> Add new poll </a>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <asp:DataList ID="DataList1" runat="server" OnItemDataBound="DataList1_ItemDataBound">
                        <ItemTemplate>
                            ...
                            </br> <a class="btn btn-primary" href="../poll.aspx?b=<%# Eval("Text") %>">View Poll<span class="glyphicon glyphicon-chevron-right">
                            </span></a>&nbsp;&nbsp;&nbsp;&nbsp<a href="Edit.aspx?t=poll&b=<%# Eval("Text") %>" class="btn btn-primary"><i class="glyphicon glyphicon-edit">
                            </i>Edit </a>&nbsp;&nbsp;&nbsp;&nbsp
                            <hr />
                        </ItemTemplate>
                    </asp:DataList>
