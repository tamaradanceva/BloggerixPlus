<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="document.aspx.cs" Inherits="document" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-1">
                <asp:DataList ID="dlDoc" runat="server" OnItemDataBound="dlBlog_ItemDataBound">
                    <ItemTemplate>
                        <div class="row">
                            <h2>
                                <a href="#">
                        ...
                        <p>
                            ...
                            <%# Eval("Description") %></p>
                        <p class="lead">
                            <object data="getDoc.ashx?b=<%# Eval("Text") %>" type="application/pdf" width="100%" height="500px">
                                <p>
            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                    ...
                    <ul class="list-group">
                        <asp:DataList ID="LatestDocs" runat="server">
                            <ItemTemplate>
                                <li class="list-group-item"><a href="document.aspx?b=<%# Eval("Text") %>">
                                    <%# Eval("Title") %></a></li>
                            </ItemTemplate>
                        </asp:DataList>
                    </ul>
